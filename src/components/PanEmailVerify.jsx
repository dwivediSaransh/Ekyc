        ...
        <div className="auth-inner">
            <form>
                ...
                <div className="form-group">
                    ...
                    <TextField type="text" id="fieldSelectorId" value={pan} onChange={(e)=>{let cData = e.target.value.toUpperCase(); setPan(cData)}} className="form-control"  label="Enter PAN NO" />
                    {/* <input type="text" value={contact} onChange={(e)=>setEmail(e.target.value)} className="form-control" placeholder="Enter Contact" /> */}
                </div>
                <div className="form-group">
                    {/* <label>Enter Contact</label> */}
                    <TextField type="text" value={name} onChange={(e)=>{let cData = e.target.value.toUpperCase(); setName(cData)}} className="form-control"  label="Enter NAME" />
                    {/* <input type="text" value={contact} onChange={(e)=>setEmail(e.target.value)} className="form-control" placeholder="Enter Contact" /> */}
                </div>
                <div className="form-group">
                    {/* <label>Enter Contact</label> */}
             ...
             <div className="form-group">
                    {/* <label>Enter Contact</label> */}
                    <TextField type="number" value={bank} onChange={(e)=>setbank(e.target.value)} className="form-control"  label="BANK ACCOUNT NO." />
                    {/* <input type="text" value={contact} onChange={(e)=>setEmail(e.target.value)} className="form-control" placeholder="Enter Contact" /> */}
                </div>
                <div className="form-group">
                    {/* <label>Enter Contact</label> */}
                    <TextField type="text" value={ifsc} onChange={(e)=>{let cData = e.target.value.toUpperCase(); setifsc(cData)}} className="form-control"  label="BANK IFSC" />
                    {/* <input type="text" value={contact} onChange={(e)=>setEmail(e.target.value)} className="form-control" placeholder="Enter Contact" /> */}
                </div>
             </div>
