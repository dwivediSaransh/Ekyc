      ...
      <div className="auth-wrapper">
        <div className="auth-inner">
            ...
            <div className="btn-class-submit">
                ...
                <button type="submit" onClick={getSubmit} className="btn btn-primary btn-block btn-submit">Verify Email</button>
                <button type="submit" onClick={getVerify} className="btn btn-primary btn-block btn-verify">Submit</button>
                </div>
            </form>
